        ...
        <section className="rounded-3xl border border-[#d9e2ec] bg-white p-4 shadow-sm sm:p-5">
            <div className="grid gap-3 md:grid-cols-[minmax(200px,1fr)_200px_auto]">
                <input
                    ...
                    className="w-full rounded-2xl border border-[#d3dce6] bg-[#f8fafd] px-4 py-3 text-sm text-[#202124] outline-none transition focus:border-[#1a73e8] focus:ring-2 focus:ring-[#d2e3fc]"
                />
                ...
                <label className="inline-flex items-center gap-2 rounded-2xl border border-[#d3dce6] bg-[#f8fafd] px-4 py-3 text-sm text-[#3c4043]">
                    <input
                        type="checkbox"
