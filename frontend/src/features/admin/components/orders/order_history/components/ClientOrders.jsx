        ...
        <aside className="border-b border-line bg-white p-5 xl:border-b-0 xl:border-r">
            ...
            <div className="mt-3 space-y-2">
                <input
                    ...
                    className="w-full rounded-xl border border-line bg-white px-4 py-2 text-xs text-word"
                />
                <select
                    value={statusFilter}
                ...
                {filteredOrders.length ? (
                    filteredOrders.map((order) => {
                        ...
                        return (
                            ...
                            >
                                {/* LEFT ID */}
                                <div className="shrink-0 text-xs font-semibold text-label/50">
                                ...
                                <div className="flex min-w-0 flex-1 flex-col">
                                    ...
                                    {/* BOTTOM ROW */}
                                    <div className="mt-2 flex items-center justify-between text-xs text-word">
                    ...
                    <div className="rounded-2xl border border-dashed border-line bg-white p-5 text-sm text-word">
